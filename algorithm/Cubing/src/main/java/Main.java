...
public class Main {
	...
	private static void turnU (Boolean flag) {
		...
		if(flag) {
			...
			for(int i=0; i<3; i++) {
				temp[i+6] = cube[5][2-i][0];
				cube[5][2-i][0] = temp[i+3];
			}
